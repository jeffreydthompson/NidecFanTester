...
_Bool GET_Hi_Pass(){
    _Bool result = (tach_front_acc >= FAN_RPM_LIMITS_LOW[1]) && (tach_front_acc <= FAN_RPM_LIMITS_HIGH[1]) &&
...
_Bool GET_Tach_Pass() {
    _Bool result = GET_Tach_Front_Pass() && GET_Tach_Back_Pass();
    tach_front_acc = 0;
    tach_back_acc = 0;
    return result;
}

_Bool GET_Tach_Front_Pass(){
    if (LATCbits.LATC1) {
